...
const education = [
  {
    ...
    title: "B.Sc. Ingenieurinformatik",
    company: "HTW Berlin",
    description:
      "Studying the intersection of software engineering and engineering disciplines, building on professional application-development experience with a deeper academic foundation in computer science and technical systems.",
    skills: [
      "Computer Science",
  ...
  {
    year: "2021 — 2024",
    title: "Computer Science Expert in Application Development",
    company: "IHK Vocational Training",
    description:
...
const Education = () => {
  return (
    <section aria-labelledby="education-heading">
      <h2 id="education-heading" className="text-2xl font-semibold mb-6 text-gray-300">Education</h2>
